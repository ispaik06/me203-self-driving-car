...
LANE_SPEED_MIN = 15   # Left / Right 때 사용
LANE_SPEED_MAX = 16   # Straight / Green 때 사용
...
def pid_autonomous_loop():
    ...
    while True:
        ...
        left  = smooth(last_left,  raw_left, ALPHA_LEFT)
        right = smooth(last_right, raw_right, ALPHA_RIGHT)
